...
<p>Let $f(N)$ be the smallest positive integer that is not coprime to any positive integer $n \le N$ whose least significant digit is $3$.</p>
...
[Link to problem](https://projecteuler.net/problem=838)
-}
